...
const Contact = () => {
    ...
    return (
        <div
            id="contact"
            className="mb-10 flex flex-col items-center justify-center rounded-xl bg-base-200 dark:bg-gray-800/50 backdrop-blur-[2px]  p-5  dark:text-white md:p-10 lg:mb-16 lg:p-16"
        >
            ...
            <div className="grid grid-cols-1 justify-between gap-10 lg:grid-cols-2">
                ...
                <div className="m-0 grid w-full grid-cols-1 items-center justify-center p-0">
                    ...
                    <div className="mt-8 flex w-full items-center justify-start gap-4 md:mt-6">
                        ...
                        <Link
                            href={`https://facebook.com/shawal.islam.32`}
                            target="_blank"
                        >
                        ...
                        <Link href={`https://www.instagram.com/_does.nt_matter_`} target="_blank">
