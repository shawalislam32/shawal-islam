            ...
            <div className="flex flex-col items-center justify-center gap-6 pt-14 md:flex-row lg:gap-24">
                <div className="">
                    <div className="flex h-60 w-60 flex-col items-center justify-center gap-1 rounded-xl border-2 border-transparent shadow transition-all duration-300 hover:scale-[1.05] hover:border-blue-400 hover:shadow-lg bg-base-200 dark:bg-gray-800/30 backdrop-blur-[2px] ">
                        ...
                        />
                        <h1 className="font-semibold text-black dark:text-base-100">Web Development</h1>
                ...
                <div className="">
                    <div className="flex h-60 w-60 flex-col items-center justify-center gap-1 rounded-xl border-2 border-transparent shadow transition-all duration-300 hover:scale-[1.05] hover:border-blue-400 hover:shadow-lg bg-base-200 dark:bg-gray-800/30 backdrop-blur-[2px] ">
                        ...
                        />
                        <h1 className="font-semibold text-gray-500 dark:text-base-300">UI/UX Design</h1>
                        <p className="text-sm text-gray-500 dark:text-base-300">51 Projects</p>
                        <h1 className="text-2xl font-bold text-secondary">3+</h1>
                        <p className="text-sm text-gray-500 dark:text-base-300">
                            Years of Experience
                        </p>
                ...
                <div className="">
                    <div className="flex h-60 w-60 flex-col items-center justify-center gap-1 rounded-xl border-2 border-transparent shadow transition-all duration-300 hover:scale-[1.05] hover:border-blue-400 hover:shadow-lg bg-base-200 dark:bg-gray-800/30 backdrop-blur-[2px] ">
                        ...
                        />
                        <h1 className="font-semibold text-gray-500 dark:text-base-300">API Development</h1>
                        <p className="text-sm text-gray-500 dark:text-base-300">11 Projects</p>
                        <h1 className="text-2xl font-bold text-secondary">3+</h1>
                        <p className="text-sm text-gray-500 dark:text-base-300">
                            Years of Experience
                        </p>
